...
import com.mercadoapp.di.NetworkModule_ProvideJsonFactory;
...
import com.mercadoapp.ui.address.AddressListViewModel_HiltModules;
import com.mercadoapp.ui.auth.LoginViewModel;
import com.mercadoapp.ui.auth.LoginViewModel_HiltModules;
import com.mercadoapp.ui.auth.RegisterViewModel;
import com.mercadoapp.ui.auth.RegisterViewModel_HiltModules;
import com.mercadoapp.ui.cart.CartViewModel;
import com.mercadoapp.ui.cart.CartViewModel_HiltModules;
import com.mercadoapp.ui.checkout.CheckoutViewModel;
...
public final class DaggerMercadoApp_HiltComponents_SingletonC {
  private DaggerMercadoApp_HiltComponents_SingletonC() {
  }
  ...
  public static final class Builder {
    ...
    public MercadoApp_HiltComponents.SingletonC build() {
      Preconditions.checkBuilderRequirement(applicationContextModule, ApplicationContextModule.class);
      return new SingletonCImpl(applicationContextModule);
    }
  }

  private static final class ActivityRetainedCBuilder implements MercadoApp_HiltComponents.ActivityRetainedC.Builder {
    ...
    @Override
    public MercadoApp_HiltComponents.ActivityRetainedC build() {
      Preconditions.checkBuilderRequirement(savedStateHandleHolder, SavedStateHandleHolder.class);
      return new ActivityRetainedCImpl(singletonCImpl, savedStateHandleHolder);
    }
  }

  private static final class ActivityCBuilder implements MercadoApp_HiltComponents.ActivityC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public MercadoApp_HiltComponents.ActivityC build() {
      Preconditions.checkBuilderRequirement(activity, Activity.class);
      return new ActivityCImpl(singletonCImpl, activityRetainedCImpl, activity);
    }
  }

  private static final class FragmentCBuilder implements MercadoApp_HiltComponents.FragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public MercadoApp_HiltComponents.FragmentC build() {
      Preconditions.checkBuilderRequirement(fragment, Fragment.class);
      return new FragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragment);
    }
  }

  private static final class ViewWithFragmentCBuilder implements MercadoApp_HiltComponents.ViewWithFragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public MercadoApp_HiltComponents.ViewWithFragmentC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewWithFragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragmentCImpl, view);
    }
  }

  private static final class ViewCBuilder implements MercadoApp_HiltComponents.ViewC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public MercadoApp_HiltComponents.ViewC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, view);
    }
  }

  private static final class ViewModelCBuilder implements MercadoApp_HiltComponents.ViewModelC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public MercadoApp_HiltComponents.ViewModelC build() {
  ...
  private static final class ServiceCBuilder implements MercadoApp_HiltComponents.ServiceC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public MercadoApp_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(singletonCImpl, service);
    }
  }

  private static final class ViewWithFragmentCImpl extends MercadoApp_HiltComponents.ViewWithFragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class FragmentCImpl extends MercadoApp_HiltComponents.FragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewCImpl extends MercadoApp_HiltComponents.ViewC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityCImpl extends MercadoApp_HiltComponents.ActivityC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewModelCImpl extends MercadoApp_HiltComponents.ViewModelC {
  ...
  private static final class ActivityRetainedCImpl extends MercadoApp_HiltComponents.ActivityRetainedC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ServiceCImpl extends MercadoApp_HiltComponents.ServiceC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class SingletonCImpl extends MercadoApp_HiltComponents.SingletonC {
    ...
    private Provider<MercadoApiService> provideMercadoApiServiceProvider;
    ...
    private Provider<RemoteOrderRepository> remoteOrderRepositoryProvider;
    ...
    private AuthInterceptor authInterceptor() {
      return new AuthInterceptor(authDataStoreProvider.get());
    }

    private TokenRefreshInterceptor tokenRefreshInterceptor() {
      return new TokenRefreshInterceptor(authDataStoreProvider.get());
    }

    private CartDao cartDao() {
      return DatabaseModule_ProvideCartDaoFactory.provideCartDao(provideMercadoDatabaseProvider.get());
    }

    private ProductDao productDao() {
      return DatabaseModule_ProvideProductDaoFactory.provideProductDao(provideMercadoDatabaseProvider.get());
    }

    @SuppressWarnings("unchecked")
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.authDataStoreProvider = DoubleCheck.provider(new SwitchingProvider<AuthDataStore>(singletonCImpl, 4));
    ...
    @Override
    public void injectMercadoApp(MercadoApp mercadoApp) {
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.mercadoapp.data.repository.AuthRepositoryImpl 
          return (T) new AuthRepositoryImpl(singletonCImpl.provideMercadoApiServiceProvider.get(), singletonCImpl.authDataStoreProvider.get());

          case 1: // com.mercadoapp.data.remote.api.MercadoApiService 
          return (T) NetworkModule_ProvideMercadoApiServiceFactory.provideMercadoApiService(singletonCImpl.provideRetrofitProvider.get());
          ...
          return (T) NetworkModule_ProvideOkHttpClientFactory.provideOkHttpClient(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.authInterceptor(), singletonCImpl.tokenRefreshInterceptor());

          case 4: // com.mercadoapp.data.local.datastore.AuthDataStore 
